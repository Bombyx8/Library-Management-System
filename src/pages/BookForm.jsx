    ...
    return (
        <div className="h-screen">
            <form className="w-full max-w-lg mx-auto mt-5" onSubmit={submitForm}>
                ...
                <div className="flex flex-wrap -mx-3 mb-6">
                    <div className="w-full px-3">
                        ...
                        <div className="flex items-center space-x-2">
                            ...
                            <button type='button' onClick={addCategory} className="bg-violet-800 p-1 rounded-lg mb-3">
                ...
                {/* create book */}
                <button className='text-white bg-violet-800 px-3 py-2 rounded-2xl flex justify-center items-center gap-1 w-full'>
